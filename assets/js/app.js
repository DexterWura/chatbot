// Enhanced app.js - Backward compatible wrapper
// Uses ChatApp class if available, otherwise falls back to legacy code

if (typeof ChatApp !== 'undefined' && window.chatApp) {
  // Use new OOP ChatApp
  console.log('Using enhanced ChatApp');
} else {
